"""
Django settings for thedatalab project.
...
SECRET_KEY = 'h_scu-9x78#c4x_%606ji8qy+lu30x&$(mmut$=3cqxno7(ou@'
...
WSGI_APPLICATION = 'thedatalab.wsgi.application'
